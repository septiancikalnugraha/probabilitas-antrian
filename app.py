...
<body>
    ...
    <div class="result-container">
        ...
        <ol>
            ...
            <p>\\[ \\lambda = \\frac{{1}}{{\\text{{Waktu Antar Kedatangan}}}} = \\frac{{1}}{{{waktu_antar_kedatangan:.2f}}} = {lambda_val:.4f} \\]</p>

            <li>Hitung laju pelayanan \\( \\mu \\):</li>
            <p>\\[ \\mu = \\frac{{1}}{{\\text{{Waktu Pelayanan}}}} = \\frac{{1}}{{{waktu_pelayanan:.2f}}} = {mu:.4f} \\]</p>

            <li>Hitung tingkat pemanfaatan pelayan \\( \\rho \\):</li>
            <p>\\[ \\rho = \\frac{{\\lambda}}{{2 \\mu}} = \\frac{{{lambda_val:.4f}}}{{2 \\times {mu:.4f}}} = {rho:.4f} \\]</p>

            <li>Hitung waktu total dalam sistem \\( W \\):</li>
            <p>\\[ W = \\frac{{1}}{{\\mu - \\frac{{\\lambda}}{{2}}}} = \\frac{{1}}{{{mu:.4f} - \\frac{{{lambda_val:.4f}}}{{2}}}} = {W:.4f} \\] menit</p>

            <li>Hitung waktu tunggu dalam antrian \\( W_q \\):</li>
            <p>\\[ W_q = \\frac{{\\lambda^2}}{{2 \\mu (\\mu - \\frac{{\\lambda}}{{2}})}} = \\frac{{{lambda_val:.4f}}}{{2 \\times {mu:.4f} \\times \\left({mu:.4f} - \\frac{{{lambda_val:.4f}}}{{2}}\\right)}} = {Wq:.4f} \\] menit</p>
        </ol>

        <p><strong>Hasil Akhir:</strong></p>
        <p>Laju Kedatangan (\\( \\lambda \\)): \\( {lambda_val:.4f} \\) kedatangan/menit</p>
        <p>Laju Pelayanan (\\( \\mu \\)): \\( {mu:.4f} \\) pelayanan/menit</p>
